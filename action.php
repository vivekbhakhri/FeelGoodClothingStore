...
error_reporting(0);
	...
	if(isset($_POST['getProduct'])){
		...
		if(isset($_POST['price_sorted'])){
			$product_query="SELECT * FROM products where product_price<100";
		}
		elseif(isset($_POST['price_sorted1'])){
			$product_query="SELECT * FROM products where product_price<=50";
		}
		elseif(isset($_POST['pop_sorted'])){
			$product_query="SELECT * FROM products where product_price<1000";
		}
		else{
			...
			while($row=mysqli_fetch_array($run_query)){
				...
				echo "<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<button pid='$pro_id' class='quicklook btn btn-danger btn-xs' style='float:right;margin:2px'>Quick look</button>&nbsp;&nbsp;
								<button pid='$pro_id' class='product btn btn-success btn-xs' style='float:right;margin:2px'>Add to Cart</button>&nbsp;&nbsp;
								</div>
							</div></div>";
			}
		}
