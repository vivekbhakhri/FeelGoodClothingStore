<?php 
  ...
  $authors = $connection->query("SELECT * FROM products LIMIT $paginationStart, $limit")->fetchAll();
          ...
          <div class="col-md-12 col-sm-12 ">
            <div class="dashboard_graph">
              ...
              <div class="row x_title">
                <div class="col-md-12">
                  <h3 style="padding:10px">Product Information </h3>
                </div>
                   ...
                   <!--<button class="btn btn-dark btn-sm" data-toggle="modal" data-target="#addagent"><span class="glyphicon glyphicon-plus"> </span> Add Agent</button>-->
                    ...
                    <!-- Select dropdown -->
                        ...
                        <div class="d-flex flex-row bd-highlight mb-3">
                             <button class="btn btn-dark btn-sm" data-toggle="modal" data-target="#addagent"><span class="glyphicon glyphicon-plus"> </span> Add Product</button>
                         
                       <a href="product.php">  <button class="btn btn-success btn-sm"><span class="glyphicon glyphicon-refresh"> </span> Reload Data</button></a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="word" name="word" class="form-control"></textarea>
                                        ...
                                        $query = "INSERT INTO $usertable (product_cat,product_title,product_price,product_desc,product_image,product_keywords,status,quantity)
                                         VALUES ('$_POST[cat]','$_POST[title]','$_POST[price]','$_POST[desc]','$file_name','$_POST[word]','Available','100')";
        ...
        <table class="table table-bordered table-striped mb-6" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="../images/<?php echo $author['product_image']; ?>"  style="width:50px"/></td>
                    <td><?php echo $author['product_cat']; ?></td>
                    <td><?php echo $author['product_title']; ?></td>
                    <td>$<?php echo $author['product_price']; ?></td>
                    <td><?php echo $author['product_desc']; ?></td>
                    <td><?php echo $author['product_keywords']; ?></td>
                    ...
                    <td>
                      ...
                      <a href='deleteproduct.php?id=<?php echo $author['product_id']; ?>'><span class='glyphicon glyphicon-trash'></span></a>
   
   
                   
                    <a href="#"  data-toggle="modal" data-target="#a<?php echo $author['product_id']; ?>" ><img src="images/update.png" style="width:20px"/></a>
                   
                    </td>
                    
                    <!--Edit Modal -->
                      <div class="modal fade" id="a<?php echo $author['product_id']; ?>" role="dialog">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">Edit Product Information ID : <?php echo $author['product_id']; ?></h4>
                            </div>
                            <div class="modal-body">
                        ...
                        <button type='submit' class='form-control btn btn-success'>EDIT</button>
                                              ...
                                              <div class='form-group'>
                                                <label for='branch'><b>Product ID</b></label>
                                                <input type='text' value="<?php echo $author['product_id']; ?>" name='id' id='id' class='form-control' readonly>
                                                </div>
                                              <div class='form-group'>
                                                <label for='section'><b>Quantity</b></label>
                                                <input type='text' value="<?php echo $author['quantity']; ?>" name='lname' id='lname' class='form-control'>
                                                </div>
