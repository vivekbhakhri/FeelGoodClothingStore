<?php 
  ...
  $authors = $connection->query("SELECT * FROM cart LIMIT $paginationStart, $limit")->fetchAll();
        ...
        <table class="table table-bordered table-striped mb-6" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <!-- <td><?php echo $author['tr_id']; ?></td> -->
                    <td>
                                    
                   
                    <a href="#"  data-toggle="modal" data-target="#a<?php echo $author['id']; ?>" ><img src="images/update.png" style="width:20px"/></a>
                    ...
                    <!--Edit Modal -->
                      <div class="modal fade" id="a<?php echo $author['id']; ?>" role="dialog">
                        ...
                        <button type='submit' class='form-control btn btn-success'>EDIT</button>
                                              ...
                                              <div class='form-group'>
                                                <label for='branch'><b>Order ID</b></label>
