  ...
  <section id="intro" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="intro-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>We're here to<br><span>solve</span><br>solve everyday Shooping Needs!</h2>
        <div>
        ...
        <div class="row">
                        ...
                        echo  '
                          ...
                          <div class="icon-box" style="margin-bottom: 10px;">
                            ...
                            <div class=""> <a href="menu.php?rid=' . $row['product_id'] . '">
                           
                            <hr/>
                            <img src="images/' . $row['product_image'] . '" alt="restaurant" style="width:100px;height:90px"></div>
                            <h2 class="title"><a href="" style="font-size: 20px;">' . $row['product_title'] . '</h2>
                            <h4 class="title"><a href="" style="font-size: 14px;">' . $row['product_price'] . '$</a></h4>
                           
                            <button class="btn btn-success btn-sm" onclick="alertcart()">Add to Cart</button>
